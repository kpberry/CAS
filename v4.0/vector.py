...
class Vector:
    ...
    #in the eval method of a function, there is an exec that uses the 
    #string representation of a parameter, so the string representation
    #of a vector should look identical to a vector constructor
    def __str__(self):
        return 'Vector(' + str(self.components)[1:len(str(self.components))-1] + ')'
